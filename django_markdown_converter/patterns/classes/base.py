...
class PatternManager:
    ...
    def InitialiseClasses(self) -> None:
        """collect the subclasses and initialise them"""
        for _ in Pattern.__subclasses__():
            inst = _(manager=self)
...
class Pattern:
    ...
    def __init__(self, name:str="base", pattern_object:dict={}, manager:PatternManager=None, *args, **kwargs) -> None:
        self.name = name
